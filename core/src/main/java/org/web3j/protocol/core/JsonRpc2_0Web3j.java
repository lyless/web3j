...
public class JsonRpc2_0Web3j implements Web3j {
    ...
    @Override
    public Request<?, EthTraceTransaction> debugTraceTransaction(String transactionHash) {
        Map<String, Object> traceConfig = new HashMap<>();
        traceConfig.put("tracer", "callTracer");
        traceConfig.put("disableStack", true);
        traceConfig.put("disableMemory", true);
        traceConfig.put("disableStorage", true);
        traceConfig.put("reexec", 1024);
        return new Request<>(
                "debug_traceTransaction",
                Arrays.asList(transactionHash, traceConfig),
                web3jService,
